...
class AuctionsConsumer(AsyncWebsocketConsumer):
    ...
    async def connect(self):
        ...
        translation.activate(self.scope['user'].lang)
...
class AuctionConsumer(WebsocketConsumer):
    ...
    def connect(self):
        ...
        translation.activate(self.user.lang)
        # translation.activate(self.user.lang)
    ...
    def receive(self, text_data=None, bytes_data=None):
        ...
        try:
            wallet.transaction(Decimal(text_data) * -1, "💎 Auction", f"Deposit #{self.auction.id}")
